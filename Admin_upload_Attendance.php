...
if($_REQUEST)
{
    ...
    $query ="UPDATE user_details set attendance=$attendence where rollno='$rollno'; ";
	...
	{
        echo '<script>alert("Roll no. dont exist")</script>';
	}
}
                                ...
                                <div class="row">
                                    <div class="col-md-6 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rollno"  placeholder="Roll Number" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 pl-1">
                                        <div class="form-group">
                                            <label>Attendance In Percentage(%)</label>
                                            <input type="text" class="form-control" name="attendence" pattern="[0-9]{2}" title="Please input 2 digit number." placeholder="Insert Attendance in Percentage" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <button class="btn btn-success btn-block" type="submit" onclick="demo.showNotification('bottom','left')">Insert</button>
                                </div>
                            </div>
</form>
                        </div>
