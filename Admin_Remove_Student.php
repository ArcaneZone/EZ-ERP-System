...
if($_REQUEST)
{
    ...
    $deleteerpid = $_REQUEST['delete_erpid'];
    
    $conn = mysqli_connect($host,$user,$pass,$db);
	
    $query ="DELETE FROM user_details  WHERE erpid='$deleteerpid' ;";
                            ...
                            <div class="row">
                                    <div class="col-md-12 pr-1">
                                        <div class="form-group">
                                            <label>ERP ID</label>
                                            <input type="none" class="form-control" name="delete_erpid" placeholder="Enter ERP Number">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <button class="btn btn-success btn-block" type="submit" onclick="demo.showNotification('bottom','left')">Remove Student</button>
                                </div>
                            </form>   
