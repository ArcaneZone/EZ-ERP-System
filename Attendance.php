                                ...
                                <div class="row">
                                    <div class="col-md-6 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rollno" disabled value="<?php echo $rollno;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 pl-1">
                                        <div class="form-group">
                                            <label>Attendance In Percentage(%)</label>
                                            <input type="text" class="form-control" name="attendence" disabled value="<?php if($attendance!=NULL){echo $attendance;}else{echo 'Not Uploaded';}?>" >
                                        </div>
                                    </div>
                                </div>
